...
export default class Lexer {
    ...
    tokenize() {
        while (this.pos < this.input.length) {
            ...
            if (this._match(/^(TORNEO|EQUIPOS|ELIMINACION|fase|partido|goleador|jugador|equipo|minuto|nombre|sede)\b/iy, "RESERVADA")) continue;
            ...
            if (this._match(/^[A-Za-zÀ-ÿ_][A-Za-zÀ-ÿ0-9_]*/y, "IDENTIFICADOR")) continue;
